...
generate_agents_md() {
    ...
    cat > "$output" << HEADER
<!-- PIV Framework v${version} - https://github.com/galando/universal-ai-dev-framework -->
...
*Universal AI Dev Framework v${version} - https://github.com/galando/universal-ai-dev-framework*
